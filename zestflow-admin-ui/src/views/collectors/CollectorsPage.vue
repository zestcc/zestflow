  ...
  <div class="collectors-page">
    ...
    <el-form :model="filter" inline size="default" style="margin-bottom:12px">
      ...
      <el-form-item :label="$t('collectors.collectorId')">
        <el-input v-model="filter.collectorId" :placeholder="$t('collectors.collectorIdPlaceholder')" clearable style="width:180px" />
      </el-form-item>
    ...
    >
      <el-table-column prop="collectorId" :label="$t('collectors.collectorId')" show-overflow-tooltip />
      ...
      <el-table-column :label="$t('collectors.address')" show-overflow-tooltip>
      ...
      <el-table-column :label="$t('collectors.lastHeartbeat')" show-overflow-tooltip>
        <template #default="{ row }">
