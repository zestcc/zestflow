  ...
  <div>
    <div class="page-header">
      <div class="stats-summary">
        <span style="font-weight:600;color:#409eff">{{ $t('demo.records.total') }} {{ total }}</span>
        <el-select
        ...
        <el-input v-model="filter.keyword" :placeholder="$t('demo.records.sceneNamePlaceholder')" clearable style="width:200px;margin-left:16px" @keyup.enter="handleSearch" />
