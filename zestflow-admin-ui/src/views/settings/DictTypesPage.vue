  ...
  <div class="dict-types-page">
    ...
    <div class="dict-layout">
      ...
      <main v-if="currentType" class="dict-data-panel">
        ...
        <div v-if="dataViewMode === 'table'" class="dict-table-wrap">
          <ResponsiveTable
...
const paginatedDataList = computed(() => {
  ...
  return filteredDataList.value.slice(start, start + dataPageSize.value)
})
...
async function refreshData() {
  ...
  try {
    ...
    const maxPage = Math.max(1, Math.ceil(filteredDataList.value.length / dataPageSize.value))
