...
- **StrictV1 gate**: `scripts/blackbox/run-v1-acceptance.ps1` (full `mvn test` + cluster + npm build + all-profile E2E + strict production-acceptance), release gate Exit 0
...
- All Maven modules unified at **1.0.0** (release tag `v1.0.0`)
