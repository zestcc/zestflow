...
class TenantTemplateClonerTest {
    ...
    void setUp() {
        cloner = new TenantTemplateCloner(
                roleMapper, dictTypeMapper, dictDataMapper, playgroundSceneMapper, scheduleMapper, sysConfigMapper, tenantModeConfig);
    }
    ...
    void cloneFromTemplate_skipsWhenSameTenant() {
        ...
        verifyNoInteractions(roleMapper, dictTypeMapper, dictDataMapper, playgroundSceneMapper, scheduleMapper, sysConfigMapper);
    }
