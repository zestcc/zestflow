...
public interface ErrorCode {
    ...
    String DICT_DATA_HAS_CHILDREN = "DICT_DATA_HAS_CHILDREN";
    String DICT_DATA_PARENT_CYCLE = "DICT_DATA_PARENT_CYCLE";
    String DICT_DATA_PARENT_INVALID = "DICT_DATA_PARENT_INVALID";

    // SysConfig
    String SYS_CONFIG_NOT_FOUND = "SYS_CONFIG_NOT_FOUND";
    String SYS_CONFIG_KEY_EXISTS = "SYS_CONFIG_KEY_EXISTS";
    ...
    String AI_QUOTA_EXCEEDED = "AI_QUOTA_EXCEEDED";
}
