...
$query = @"
SELECT 'app_log.chain_event_payload' AS item, COUNT(*) AS cnt FROM information_schema.TABLES WHERE TABLE_SCHEMA='zestflow_app_log' AND TABLE_NAME='chain_event_payload'
UNION ALL SELECT 'app_log.invocation_payload', COUNT(*) FROM information_schema.TABLES WHERE TABLE_SCHEMA='zestflow_app_log' AND TABLE_NAME='invocation_payload'
